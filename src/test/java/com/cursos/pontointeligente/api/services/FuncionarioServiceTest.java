...
import com.cursos.pontointeligente.api.repositories.FuncionarioRepository;
...
public class FuncionarioServiceTest {
	...
	@Test
	public void testPersisitirFuncionario() {
...
/*	@Test
	...
	public void testBuscarFuncionarioPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("02250323097");
		assertTrue(funcionario.isPresent());
	}
}
